...
export default function Sidebar({ open, onClose, onNewChat, onUpload, onSettings, onNavigateKnowledge, onSelectConversation, conversations, userEmail, onLogout, activeView }: SidebarProps) {
    ...
    <div className="flex flex-col h-full safe-top safe-bottom">
      <div className="p-4 pb-3 space-y-1.5">
        <div className="flex items-center justify-between mb-3">
          ...
          <button
            onClick={onClose}
            className="w-10 h-10 rounded-lg flex items-center justify-center text-neutral-500 hover:text-neutral-800 dark:hover:text-white hover:bg-neutral-200 dark:hover:bg-neutral-800 transition-all"
            title="Close sidebar"
          >
        ...
        <button
          onClick={onNewChat}
          className="w-full flex items-center gap-3 rounded-lg px-4 py-4 text-base text-neutral-700 dark:text-white hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-all"
        >
      ...
      <div className="p-2 space-y-1">
        <button
          ...
          className={`w-full flex items-center gap-3 rounded-lg px-4 py-4 text-base transition-all ${
        ...
        >
          ...
          <span className="flex-1 text-left">Buckets</span>
        </button>
        <button
          onClick={onSettings}
          className="w-full flex items-center gap-3 rounded-lg px-4 py-4 text-base text-neutral-600 dark:text-neutral-400 hover:text-neutral-800 dark:hover:text-neutral-200 hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-all"
        >
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <button
          onClick={onLogout}
          className="w-full flex items-center gap-3 rounded-lg px-4 py-4 text-base text-neutral-600 dark:text-neutral-400 hover:text-red-500 hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-all"
        >
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  return (
    <>
      <aside className="hidden md:flex w-72 flex-col flex-shrink-0 relative z-30 bg-neutral-50 dark:bg-neutral-950 border-r border-neutral-200 dark:border-neutral-800">
        {sidebarContent}
      </aside>
      <aside className="md:hidden fixed inset-y-0 left-0 z-30 flex animate-slide-in-left">
        <div className="w-72 bg-neutral-50 dark:bg-neutral-950 flex-shrink-0 h-full shadow-2xl">
          {sidebarContent}
        </div>
      </aside>
    </>
